...
const QG_DATA = {
  ...
  powerapps: [
    ...
    {
      id: "powerapps-1774622274510",
      title: "Modern Date Picker",
      icon: "bi-circle",
      cards: [
        { id: "powerapps-1774622326114", name: "Yaml Example of modern date picker", tag: "YAML", tagType: "formula", code: "- StartDatePicker:\n    Control: ModernDatePicker@1.0.0\n    Properties:\n      Placeholder: =\"Select start date\"\n      DefaultDate: =Today()\n      StartDate: =Today()\n      EndDate: =Today() + 365\n      StartOfWeek: =StartOfWeek.Monday\n      X: =40\n      Y: =100\n      Width: =280\n      Height: =32\n\n- EndDatePicker:\n    Control: ModernDatePicker@1.0.0\n    Properties:\n      Placeholder: =\"Select end date\"\n      Format: =DatePickerFormat.Short\n      DefaultDate: =Today() + 7\n      StartOfWeek: =StartOfWeek.Monday\n      X: =340\n      Y: =100\n      Width: =280\n      Height: =32", desc: "Shows Start and End date yaml examples", tags: "YAML" },
        { id: "powerapps-1774622781906", name: "Date and Time Picker", tag: "YAML Date", tagType: "formula", code: "- dtpF_StartDate_1:\n    Control: ModernDatePicker@1.0.0\n    Group: DatePickerStartDateTime\n    Properties:\n      DefaultDate: =If(IsBlank(varSelectedRecord.Start_Date), Today(), DateValue(varSelectedRecord.Start_Date))\n      EndDate: =Date(Year(Today()) + 100,12,31)\n      Format: =DatePickerFormat.Short\n      Height: =30\n      Placeholder: =\"Select start date\"\n      Size: =10\n      StartDate: =Date(1900,1,1)\n      StartOfWeek: =StartOfWeek.Monday\n      Width: =98\n      X: =16\n      Y: =252\n- ddF_StartHour:\n    Control: ModernCombobox@1.0.0\n    Group: DatePickerStartDateTime\n    Properties:\n      DefaultSelectedItems: |-\n        =If(\n            IsBlank(varSelectedRecord.Start_Date),\n            Table({Value: Text(Hour(Now()), \"00\")}),\n            Table({Value: Text(Hour(varSelectedRecord.Start_Date), \"00\")})\n        )\n      Height: =30\n      IsSearchable: =false\n      ItemDisplayText: =ThisItem.Value\n      Items: |-\n        =ForAll(\n            Sequence(24),\n            {Value: Text(Value - 1, \"00\")}\n        )\n      SelectMultiple: =false\n      Size: =10\n      Width: =50\n      X: =120\n      Y: =252\n- ddF_StartMin:\n    Control: ModernCombobox@1.0.0\n    Group: DatePickerStartDateTime\n    Properties:\n      DefaultSelectedItems: |-\n        =If(\n            IsBlank(varSelectedRecord.Start_Date),\n            Table({Value: Text(Minute(Now()), \"00\")}),\n            Table({Value: Text(Minute(varSelectedRecord.Start_Date), \"00\")})\n        )\n      Height: =30\n      IsSearchable: =false\n      ItemDisplayText: =ThisItem.Value\n      Items: |-\n        =Table(\n            {Value:\"00\"},\n            {Value:\"05\"},\n            {Value:\"10\"},\n            {Value:\"15\"},\n            {Value:\"20\"},\n            {Value:\"25\"},\n            {Value:\"30\"},\n            {Value:\"35\"},\n            {Value:\"40\"},\n            {Value:\"45\"},\n            {Value:\"50\"},\n            {Value:\"55\"}\n        )\n      SelectMultiple: =false\n      Size: =10\n      Width: =50\n      X: =180\n      Y: =252\n- Separator8_18:\n    Control: Label@2.5.1\n    Group: DatePickerStartDateTime\n    Properties:\n      Align: =Align.Center\n      BorderColor: =RGBA(0, 0, 0, 0)\n      BorderStyle: =BorderStyle.None\n      BorderThickness: =2\n      Color: =RGBA(106, 122, 127, 1)\n      DisabledBorderColor: =RGBA(0, 0, 0, 0)\n      DisabledColor: =RGBA(161, 159, 157, 1)\n      FocusedBorderThickness: =4\n      Font: =Font.'Segoe UI'\n      FontWeight: =FontWeight.Bold\n      Height: =HourValue4_20.Height\n      PaddingBottom: =0\n      PaddingLeft: =0\n      PaddingRight: =0\n      PaddingTop: =0\n      Size: =10\n      Text: =\":\"\n      Width: =10\n      Wrap: =false\n      X: =170\n      Y: =250\n", desc: "YAML for Date and Time", tags: "Yaml" }
      ]
    }
  ],
