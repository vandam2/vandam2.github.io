...
const NOTES = [
  ...
  },
  {
    ...
    category: "other",
    categoryLabel: "Other",
    excerpt: "Working with JSON across Power Apps (ParseJSON), Power Automate (Parse JSON action), and the quirks you'll hit — null handling, schema mismatches, dynamic content.",
